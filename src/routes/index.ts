...
import { apartmentDuesExemptionRouter } from "./apartment-dues-exemption.routes";
...
import { bankColumnTemplateRouter } from "./bank-column-template.routes";
...
apiRouter.use("/interest-decisions", interestRouter);
...
apiRouter.use("/bank-column-templates", bankColumnTemplateRouter);
